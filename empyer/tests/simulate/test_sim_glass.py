...
class TestGlassSimulations(TestCase):
    ...
    def test_polar_unwrapping(self):
        i = simulate_pattern(symmetry=6, k=12, radius=6, rotation_vector=(0, 0, 1), rotation=0.6)
    ...
    def test_polar_unwrapping(self):
        ...
        for j in range(0, 10):
            ...
            i = i + simulate_pattern(symmetry=s, k=12, radius=6, rotation_vector=v, rotation=ro)
