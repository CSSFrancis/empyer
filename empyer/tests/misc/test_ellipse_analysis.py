...
class TestConvert(TestCase):
    def setUp(self):
        self.ellipse = np.random.rand(10, 512, 512)
    ...
    def test_solve_ellipse(self):
        ...
        self.assertAlmostEqual(center[0,0],256, places=2)
        self.assertAlmostEqual(center[0, 1],256, places=2)
        self.assertAlmostEqual(lengths[0][1],100, places=-1)
        self.assertAlmostEqual(angle[0][0], np.pi/4, places=2)
